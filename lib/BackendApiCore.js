...
class BackendApiCore {
  ...
  _generateUnifiedOrderSignedDictSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, openId, limitPay) {
    const instance = this;
    ...
    if (undefined !== limitPay && null !== limitPay) {
      Object.assign(toBeSignedDict, {
        limit_pay: limitPay,
      });
    }
  ...
  _generateUnifiedOrderXmlStrSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, openId, limitPay) {
    const instance = this;
    const signedDict = instance._generateUnifiedOrderSignedDictSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, openId, limitPay);
  ...
  queryUnifiedOrderRespAsync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, openId, limitPay) {
    const instance = this;
    const postData = instance._generateUnifiedOrderXmlStrSync(outTradeNo, notifyUrl, nonceStr, body, totalFeeCents, tradeType, openId, limitPay);
  ...
  paymentNotificationStr2ObjAsync(str) {
    return new Promise(function(resolve, reject) {
  ...
  verifyPaymentNotificationAsync(reqBody) {
    const instance = this;
    return instance.paymentNotificationStr2ObjAsync(reqBody)
